...
public class AnaliseEnergeticaController {
    ...
    public AnaliseEnergeticaController(AnaliseEnergeticaService service) {
    ...
    public ResponseEntity<String> instrucoes() {
        return ResponseEntity.ok(
                "Use POST /analise-energetica com JSON no corpo para analisar o consumo energético."
        );
    }
...
//        double custo = calcularGastoMensal(request.consumo_kwh());
